  ...
  return (
    <button
      ...
      className="
        ...
        text-white font-bold text-[11px] md:text-base uppercase tracking-wider md:tracking-wide
      ...
      "
    >
      <svg viewBox="0 0 24 24" fill="white" className="w-4 h-4 md:w-5 md:h-5 flex-shrink-0">
