...
export default function FloatingSupport() {
    ...
    return (
        <a
            ...
            className={`fixed left-0 right-0 z-[40] flex items-center justify-center gap-3 w-full px-4 pt-3 pb-5 lg:pb-3 min-h-[56px] transition-all duration-700 transform
                ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}
                bg-gradient-to-r from-[#20ba5a] via-[#25D366] to-[#2ee66c]
                shadow-[0_-4px_24px_rgba(37,211,102,0.45)]
                border-t border-white/20 hover:brightness-110
        ...
        >
            ...
            <div className="relative z-10 flex items-center justify-center gap-2 lg:gap-3 w-full max-w-7xl mx-auto">
                <div className="flex-shrink-0 w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-white/25 flex items-center justify-center shadow-inner">
                    <svg viewBox="0 0 24 24" fill="white" className="w-4 h-4 lg:w-6 lg:h-6">
