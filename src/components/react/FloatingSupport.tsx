...
export default function FloatingSupport() {
    ...
    return (
        <a
            ...
            className={`fixed z-[60] flex items-center justify-center transition-all duration-700 transform
                ${isVisible ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}
                bg-[#25D366] text-white shadow-[0_8px_30px_rgba(37,211,102,0.4)]
                hover:scale-110 active:scale-95
                w-14 h-14 rounded-full
                right-5 bottom-[84px] lg:bottom-10 lg:right-10
            `}
        ...
        >
            ...
            {/* Subtle "VIP" badge */}
            <div className="absolute -top-1 -right-1 bg-white text-[#25D366] text-[8px] font-black px-1.5 py-0.5 rounded-full shadow-sm border border-[#25D366]/20">
                VIP
            </div>
        </a>
    );
