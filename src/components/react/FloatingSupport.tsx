...
export default function FloatingSupport() {
    ...
    return (
        <a
            ...
            className={`fixed left-0 right-0 z-[60] flex items-center justify-center gap-3 w-full px-4 py-3 min-h-[52px] lg:min-h-[56px] transition-all duration-700 transform
        ...
        >
            ...
            <div className="relative z-10 flex items-center justify-center gap-3 w-full max-w-7xl mx-auto">
                <div className="flex-shrink-0 w-9 h-9 lg:w-10 lg:h-10 rounded-full bg-white/25 flex items-center justify-center shadow-inner">
