...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#050505] text-[#FAFAF5] w-full pt-20 pb-40 border-t border-[#d4af37]/20 relative overflow-hidden font-sans">
            ...
            {/* Contenedor principal con márgenes laterales y ancho máximo */}
            <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">

                {/* Métodos de pago al inicio - Centrados y a color */}
                <div className="pt-6 pb-12 flex justify-center border-b border-[#d4af37]/10 mb-16">
                    <PaymentIcons iconClassName="h-6 w-auto" className="flex flex-wrap justify-center gap-4 opacity-80 hover:opacity-100 transition-opacity" />
                </div>

                {/* 1. Newsletter Section */}
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end border-b border-[#d4af37]/10 pb-16 mb-20 gap-10">
                    ...
                    <form className="w-full md:max-w-md flex flex-col gap-5">
                        <div className="relative group">
                            ...
                            <button
                                type="submit"
                                className="absolute right-0 top-3 text-[#d4af37] hover:text-white transition-colors duration-300"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16 mb-20">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex gap-3">
                            ...
                            <SocialLink href="https://www.tiktok.com/@dtalles_jewelry" label="TikTok" brandColor="#ffffff">
                                {/* TikTok SVG */}
                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-[17px] h-[17px]">
